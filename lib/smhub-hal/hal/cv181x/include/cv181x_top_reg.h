...
#define REG_CLK_ENABLE_REG3                     (CLKGEN_BASE + 0xC)
#define REG_CLK_ENABLE_REG4                     (CLKGEN_BASE + 0x10)
...
/* rst */
#define REG_TOP_SOFT_RST0                       (TOP_BASE + 0x3000)
#define REG_TOP_SOFT_RST1                       (TOP_BASE + 0x3004)
#define REG_TOP_SOFT_RST2                       (TOP_BASE + 0x3008)
